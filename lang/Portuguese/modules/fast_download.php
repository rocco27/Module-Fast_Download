...
define('create_alias', "Crie o alias e a respectiva pasta");
define('save_as', "Salvar como");
define('failure', "Erro, não conseguiu gerar o arquivo de alias");
define('success', "Sucesso");
define('fast_download_service_for', "Serviço de redireccionamento de downloads para %s");
define('to_the_path', "Para o caminho");
define('at_url', "no URL");
define('create_alias_for', "Criar alias para");
define('fast_dl', "Redirecionar downloads (FastDL)");
define('current_aliases_at_remote_server', "Alias ​​atuais no servidor remoto");
define('delete_selected_aliases', "Eliminar alias selecionadas");
define('no_aliases_defined', "Ainda não existem aliases da Web definidos pelo painel para este servidor remoto.");
define('fastdl_port', "Porta");
define('fastdl_port_info', "Porta no qual seu o seu Download Rapido irá começar.");
...
define('apply_settings_and_restart_fastdl', "Guarde as configurações principais e importantes antes, depois poderá reiniciar");
define('stop_fastdl', "Parar a tarefa de Download Rápido.");
define('fast_download_daemon_running', "A tarefa de Download Rapido esta em execução.");
define('fast_download_daemon_not_running', "A tarefa de Download Rápido  não está a ser executada.");
define('fastdl_could_not_be_restarted', "O serviço Download Rápido não pôde ser reiniciado.");
...
define('no_game_homes_assigned', "Neste momento não existe nenhum servidor que lhe tenha sido atribuído. Você precisará de  pedir ao seu administrador do painel/empresa para que lhe reserve um.");
...
define('match_file_extension', "Extensão de arquivo do jogo");
...
define('invalid_entries_found', "Foram encontradas entradas inválidas");
...
define('port_forwarded_to_80', "Porta reencaminhada para 80");
