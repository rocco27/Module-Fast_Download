...
define('match_file_extension_info', "Especifique extensiones separadas por coma,<br> los archivos que coincidan serán accesibles.<br><b>Vacio para acceso ilimitado.</b>.");
define('match_client_ip', "Coincide la IP del cliente");
define('match_client_ip_info', "Las conexiones con IP coincidente serán concedidas,<br>Vacio para acceso ilimitado.<br>Puede usar multiples IPs<br>o rangos separados por coma:<br>Subredes /xx<br>Ejemplo: 10.0.0.0/16<br>Subredes /xxx.xxx.xxx.xxx<br>Ejemplo: 10.0.0.0/255.0.0.0<br>Rango establecido por un guión<br>Ejemplo: 10.0.0.5-230<br>Coincidencia por asterisco<br>Ejemplo: 10.0.*.*");
