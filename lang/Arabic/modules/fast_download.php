...
define('create_alias', "إنشاء الاسم المستعار والمجلد");
define('save_as', "الحفظ في");
define('failure', "حدث خطأ، فشلت في إنشاء ملف الاسم المستعار");
define('success', "نجح");
define('fast_download_service_for', "خدمة إعادة توجيه التحميلات ل %s");
define('to_the_path', "إلى مسار");
define('at_url', "في رابط");
define('create_alias_for', "إنشاء اسم مستعار ل");
define('fast_dl', "إعادة توجيه التحميلات (تحميل سريع)");
define('current_aliases_at_remote_server', "الأسماء المستعارة الحالية في سيرفر التحكم");
...
define('remove_folders', "إزالة المجلد للأسماء المستعارة المحددة.");
define('remove_folder', "إزالة المجلد");
define('delete_alias', "حذف الاسم المستعار");
...
define('access_rules', "قواعد الوصول");
define('create_aliases', "إنشاء الأسماء المستعارة");
define('select_game', "حدد اللعبة");
define('games_without_specified_rules', "ألعاب بدون قواعد محددة");
...
define('alias_already_exists', "الاسم المستعار %s موجود من قبل.");
